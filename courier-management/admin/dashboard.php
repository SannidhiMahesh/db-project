...
<form style="position:center;color:white;font-weight:bold;font-size:50px">
    
    <!-- <a href="insertdata.php">Insert Data</a><br><br> -->

    <!-- <a href="updatedata.php">Update Data</a><br><br> -->

    <a href="deletedata.php "><p style="color:white;">Delete Data</p></a><br><br>

    <a href="deleteusers.php "><p style="color: white;">Delete Users</p></a><br><br>
    <a href="seemsg.php "><p style="color: white;">Query Message</p></a><br><br>
</form>
