...
if (isset($_POST['ph'])) {
    ...
    if (strlen($phn) == 10) {
        ...
        echo "<script>alert('Invalid phone number, phone number should be of exactly 10 digits.');</script>";
    }
}
...
<body>
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px " style="margin:auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:transparent; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    ...
                    <td>Email:</td>
                    <td><input type="textfield" name="remail" placeholder="Receiver EmailId" required></td>
                </tr>
                <tr>
                    <td>PhoneNo.:</td>
                    <td><input type="number" name="sphone" maxlength="10"  pattern="/[0-9]{10}" placeholder="sender number"  required></td>

                    <td>PhoneNo.:</td>
                    <td><input type="number" name="rphone" maxlength="10"  pattern="/[0-9]{10}" placeholder="receiver number"  required></td>
                </tr>
                <tr>
                    <td>Address:</td>
                ...
                <tr>
                    <td colspan="10" align="center"><input type="submit" name="submit" value="Place Order"  style="background-color:snow; border-radius: 15px; width: 140px; height: 50px;cursor:pointer;"></td>
                </tr>
            </table>
        </div>
    </form>
