...
<div style="overflow-x:auto;">
    <table border="0px solid" style="margin-left: auto; margin-right:auto;background-color:snow; margin-top:30px; font-weight:bold;border-spacing: 5px 15px;">
        <th colspan="4" style="text-align: center;background-color:cadetblue; width: 140px; height: 50px;">Update The Details As Required</th>
        <tr>
