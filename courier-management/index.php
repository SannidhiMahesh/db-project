...
<body>
    <h1 align='center' style="margin: 15px; color:maroon;font-weight: bold;font-family:'Times New Roman', Times, serif">GLOBAL COURIER SERVICE</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:rosybrown;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</P>
    <div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    ...
                    <p style="color:mintcream;">Don't have an account?⮞➤ <a href="register.php" style="color:brown";>Register here</a>.</p>
